...
public final class LocationDirector implements LocationListener {
    ...
    public LocationDirector(Context context) {
    ...
    public void stopUsingGPS() {
        if (locationManager != null) {
            ...
            locationManager.removeUpdates(LocationDirector.this);
        }
    }
